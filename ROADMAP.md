...
<!-- FOCUS:BEGIN -->
**Focus phase:** 8 — Backlog (3 of 7 done · 0 in progress)

**Last shipped:** Task 23 — opts: section parity — emit typed JSON Schema for schema-less opts params too on 2026-06-12

**Up next:** Task 24 — Reconcile __api__/0 spec-enrichment with the BEAM doc-chunk hints (or document the asymmetry) [D:4/B:5/U:6 → Eff:1.38] 📋
<!-- FOCUS:END -->
